...
class PDFScreen4 extends StatefulWidget {
  final String path;
  int pagenumber;
  PDFScreen4({Key key, this.path, this.pagenumber}) : super(key: key);

  _PDFScreenState4 createState() => _PDFScreenState4();
}

class _PDFScreenState4 extends State<PDFScreen4> with WidgetsBindingObserver {
      ...
      body: Stack(
        children: <Widget>[
          PDFView(
            ...
            defaultPage: box.read('pagenumber4'),
            fitPolicy: FitPolicy.BOTH,
            preventLinkNavigation:
                false, // if set to true the link is handled in flutter
            onRender: (_pages) {
              viewcontroler.setPagenumber4();
              setState(() {
                //  pages.value = _pages;
                pages.value = viewcontroler.pagenumber4.value;
            ...
            onPageChanged: (int page, int total) {
              ...
              setState(() {
                ...
                box.write("pagenumber4", currentPage.value);
                print("bax value ${box.read('pagenumber4')}");
  ...
  get floatingActionItem {
    Widget floatingPlayer = FloatingAudioPlayer(
        onPaused: onPaused,
        audiopath: "assets/chapter4.m4a",
        musicduration: "musicplayerch4");
