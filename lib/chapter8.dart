...
class PDFScreen8 extends StatefulWidget {
  final String path;
  int pagenumber;
  PDFScreen8({Key key, this.path, this.pagenumber}) : super(key: key);

  _PDFScreenState8 createState() => _PDFScreenState8();
}

class _PDFScreenState8 extends State<PDFScreen8> with WidgetsBindingObserver {
      ...
      body: Stack(
        children: <Widget>[
          PDFView(
            ...
            defaultPage: box.read('pagenumber8'),
            fitPolicy: FitPolicy.BOTH,
            preventLinkNavigation:
                false, // if set to true the link is handled in flutter
            onRender: (_pages) {
              viewcontroler.setPagenumber8();
              setState(() {
                //  pages.value = _pages;
                pages.value = viewcontroler.pagenumber8.value;
            ...
            onPageChanged: (int page, int total) {
              ...
              setState(() {
                ...
                box.write("pagenumber8", currentPage.value);
                print("bax value ${box.read('pagenumber8')}");
  ...
  get floatingActionItem {
    Widget floatingPlayer = FloatingAudioPlayer(
        onPaused: onPaused,
        audiopath: "assets/chapter8.m4a",
        musicduration: "musicplayerch8");
