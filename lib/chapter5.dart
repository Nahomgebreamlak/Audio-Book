...
class PDFScreen5 extends StatefulWidget {
  final String path;
  int pagenumber;
  PDFScreen5({Key key, this.path, this.pagenumber}) : super(key: key);

  _PDFScreenState5 createState() => _PDFScreenState5();
}

class _PDFScreenState5 extends State<PDFScreen5> with WidgetsBindingObserver {
      ...
      body: Stack(
        children: <Widget>[
          PDFView(
            ...
            defaultPage: box.read('pagenumber5'),
            fitPolicy: FitPolicy.BOTH,
            preventLinkNavigation:
                false, // if set to true the link is handled in flutter
            onRender: (_pages) {
              viewcontroler.setPagenumber5();
              setState(() {
                //  pages.value = _pages;
                pages.value = viewcontroler.pagenumber5.value;
            ...
            onPageChanged: (int page, int total) {
              ...
              setState(() {
                ...
                box.write("pagenumber5", currentPage.value);
  ...
  get floatingActionItem {
    Widget floatingPlayer = FloatingAudioPlayer(
        onPaused: onPaused,
        audiopath: "assets/chapter5.m4a",
        musicduration: "musicplayerch5");
