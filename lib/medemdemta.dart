...
class PDFScreen9 extends StatefulWidget {
  final String path;
  int pagenumber;
  PDFScreen9({Key key, this.path, this.pagenumber}) : super(key: key);

  _PDFScreenState9 createState() => _PDFScreenState9();
}

class _PDFScreenState9 extends State<PDFScreen9> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    if (box.read('pagenumbermedemdemta') == null) {
      box.write('pagenumbermedemdemta', 0);
    }
      ...
      body: Stack(
        children: <Widget>[
          PDFView(
            ...
            defaultPage: box.read('pagenumbermedemdemta'),
            ...
            onRender: (_pages) {
              ...
              setState(() {
                //  pages.value = _pages;
                pages.value = viewcontroler.medemdemta.value;
            ...
            onPageChanged: (int page, int total) {
              ...
              setState(() {
                ...
                box.write("pagenumbermedemdemta", currentPage.value);
  ...
  get floatingActionItem {
    Widget floatingPlayer = FloatingAudioPlayer(
        onPaused: onPaused,
        audiopath: "assets/medemdemta.m4a",
        musicduration: "medemdemta");
