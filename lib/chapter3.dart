...
class PDFScreen3 extends StatefulWidget {
  final String path;
  int pagenumber;
  PDFScreen3({Key key, this.path, this.pagenumber}) : super(key: key);

  _PDFScreenState3 createState() => _PDFScreenState3();
}

class _PDFScreenState3 extends State<PDFScreen3> with WidgetsBindingObserver {
      ...
      body: Stack(
        children: <Widget>[
          PDFView(
            ...
            defaultPage: box.read('pagenumber3'),
            fitPolicy: FitPolicy.BOTH,
            preventLinkNavigation:
                false, // if set to true the link is handled in flutter
            onRender: (_pages) {
              viewcontroler.setPagenumber3();
              setState(() {
                //  pages.value = _pages;
                pages.value = viewcontroler.pagenumber3.value;
  ...
  get floatingActionItem {
    Widget floatingPlayer = FloatingAudioPlayer(
        onPaused: onPaused,
        audiopath: "assets/chapter3.m4a",
        musicduration: "musicplayerch3");
